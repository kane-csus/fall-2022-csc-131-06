...
def main():
    ...
    peers = [alex_souv, anish_chouhan, brandon_kmiec, eduardo_lopez, gary_kane, haoyang_li, jonathan_camarena_camacho, joshua_cupler, kiranjot_kaur, mohammed_alchalabi, phuc_dinh, vincent_lam]
